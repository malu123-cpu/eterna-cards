          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="location.php" aria-expanded="false">
                <i class="ti ti-atom"></i>
                <span class="hide-menu">Location Registration</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="location_view.php" aria-expanded="false">
                <i class="ti ti-atom"></i>
                <span class="hide-menu">Location View</span>
              </a>
            </li>
            <!-- ---------------------------------- -->
            <!-- Dashboard -->
             ...
             <li class="sidebar-item">
              <a class="sidebar-link" href="viewCustomiztionBookings.php" aria-expanded="false">
                <div class="d-flex align-items-center gap-3">
                  ...
                  <span class="hide-menu">Manage Customization Bookings</span>
                </div>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="viewCustomizationPayments.php" aria-expanded="false">
               <i class="ti ti-credit-card"></i>
                <span class="hide-menu">Manage Customization Payments</span>
              </a>
            </li>
...
<div class="round-16 d-flex align-items-center justify-content-center">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="Admin/ui-buttons.html" aria-expanded="false">
                <i class="ti ti-layers-subtract"></i>
                <span class="hide-menu">Buttons</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="Admin/ui-alerts.html" aria-expanded="false">
                <i class="ti ti-alert-circle"></i>
                <span class="hide-menu">Alerts</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="Admin/ui-card.html" aria-expanded="false">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="Admin/ui-typography.html" aria-expanded="false">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="Admin/icon-tabler.html" aria-expanded="false">
                <i class="ti ti-archive"></i>
                <span class="hide-menu">Tabler Icon</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="Admin/sample-page.html" aria-expanded="false">
